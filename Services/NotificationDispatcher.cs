...
/// Telegram, ...). One channel failing -- a bad token, the API being down --
/// never stops the others from sending, and never surfaces as an exception to
/// the caller (ReminderBackgroundService already treats a failed send as
/// non-fatal; each channel implementation logs its own warnings).
/// </summary>
