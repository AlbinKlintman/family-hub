(function () {
    ...
    function applyCounts(data) {
        ...
        // Supported on Chromium desktop/Android; unreliable in practice on iOS
        // home-screen web apps even where the API is present (the call resolves
        // successfully but the badge doesn't always render -- a known WebKit
        // quirk, not something fixable from here) and silently unavailable in
        // Firefox/LibreWolf. The badges above are the dependable version.
